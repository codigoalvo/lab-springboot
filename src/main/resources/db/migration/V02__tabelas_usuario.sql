...
INSERT INTO security_user (email, password) VALUES ('usuario@email.com', /* usuario123 */ '$2a$10$vg7c5ezwykIr5lWG7Rly9uGQFNOtdaXrEZMz9s64mP.ivmalKwUuC');
INSERT INTO security_user (email, password) VALUES ('admin@email.com', /* admin123 */ '$2a$10$hHr8kI3BRHpweNJdn0Mg.e83mmZKkbzUf9twUbJ4cKmBZRNdf8QFK');
...
INSERT INTO security_user_profile (id_user, id_profile) VALUES (
	(SELECT id FROM security_user u WHERE u.email = 'usuario@email.com'),
	(SELECT id FROM security_profile p WHERE p.name = 'USU')
);

INSERT INTO security_user_profile (id_user, id_profile) VALUES (
	(SELECT id FROM security_user u WHERE u.email = 'admin@email.com'),
	(SELECT id FROM security_profile p WHERE p.name = 'USU')
);
